...
import { GameDriver, isOneDameEachDraw, moveRecordMatches, parsePieces, parseSideToMove } from '../../cli/cli.mjs';
...
const demoJson = async (name) =>
    JSON.parse(await readFile(`examples/demos/${name}.json`, 'utf8'));
