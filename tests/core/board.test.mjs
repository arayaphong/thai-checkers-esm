...
describe('core/board', () => {
    ...
    test('Board.fromPieces', () => {
        ...
        assert.throws(() => Board.fromPieces([[p1, pieces[0][1]], [p1, pieces[0][1]]]), Error);
    });
    ...
    test('getPieces', () => {
        ...
        assert.deepEqual(whitePieces.get(p1Canonical), { color: PieceColor.WHITE, type: PieceType.PION });
