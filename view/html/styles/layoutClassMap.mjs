...
export const layoutClassMap = Object.freeze({
  rootShell: 'min-h-screen bg-neutral-950 flex flex-col items-center justify-center p-4 font-sans text-gray-100',

  headerWrapper: 'mb-6 text-center space-y-2',
  headerTitle: 'text-4xl font-black text-emerald-400 tracking-tight flex items-center justify-center gap-3',
  ...
  statusPanel: 'bg-neutral-900 shadow-xl rounded-2xl p-5 w-full max-w-lg mb-6 border border-neutral-700',

  boardFrameWrapper: 'relative group',
  boardFrameGlow: 'absolute -inset-3 bg-gradient-to-br from-stone-700 to-stone-900 rounded-lg shadow-2xl shadow-black/60 z-0',
  boardFrameInner: 'absolute -inset-1 bg-stone-800 rounded z-0',
  boardGrid: 'relative z-10 grid grid-cols-8 grid-rows-8 w-[340px] h-[340px] sm:w-[480px] sm:h-[480px] border-2 border-stone-900 bg-stone-950 shadow-inner overflow-hidden',
